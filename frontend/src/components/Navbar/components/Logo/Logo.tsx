    ...
    <>
      ...
      >
        ...
        <rect
          ...
          width="593.295"
          height="218.065"
          style={{ fill: "none", stroke: "currentcolor", strokeWidth: "17px" }}
        />
      </svg>
    </>
  );
